...
mv:SetScript('OnEvent', function()
    if event == 'CHAT_MSG_SYSTEM' then
        ...
        if string.find(arg1, ', Entry ', 1, true) and string.find(arg1, 'MapId:') then
    ...
    elseif event == 'ADDON_LOADED' and arg1== "MaNGOS_Model_Viewer" then
        ...
        gModel:SetScript('OnMouseDown', function(mouseButton)
